...
static inline struct rbtree_node *do_closest_lookup(const struct rbtree_node *key, const struct rbtree *tree, bool closest_greater) {
    struct rbtree_node *node = tree->root, *closest = 0;
    while (node != 0) {
